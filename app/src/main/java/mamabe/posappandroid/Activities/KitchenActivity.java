...
public class KitchenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarTitle("Kitchen Station");
    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        kitchenStationFragment = new KitchenStationFragment();
        waiterStationFragment = new WaiterStationFragment();
        ViewPagerAdapter adapter = new ViewPagerAdapter(getFragmentManager());
        adapter.addFrag(kitchenStationFragment, "Item");
        adapter.addFrag(waiterStationFragment, "Ordering");
