...
public class CheckoutDetailAdapter extends RecyclerView.Adapter<CheckoutDetailAdapter.ViewHolder>{
    ...
    private CheckoutDetailAdapterListener listener;

    public interface CheckoutDetailAdapterListener {
        void onItemClick(OrderDetail item, int position);
    }

    public CheckoutDetailAdapter(ArrayList<OrderDetail> items, CheckoutDetailAdapterListener listener, Context context) {
        this.items = items;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, TextView tvMenuName, TextView tvMenuPrice, TextView tvMenuQty,
                          ...
                          TextView tvTakeaway, TextView tvAdditional, ConstraintLayout menuStatusColor, LinearLayout discHolder, View item) {
            super(itemView);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_checkout_detail_item, parent, false);
        TextView tvMenuName = (TextView)v.findViewById(R.id.checkout_detail_item_name);
        TextView tvMenuPrice = (TextView)v.findViewById(R.id.checkout_detail_item_price);
        TextView tvMenuQty = (TextView)v.findViewById(R.id.checkout_detail_item_count);
        TextView tvMenuDiscPrice = (TextView)v.findViewById(R.id.checkout_detail_item_disc_price);
        TextView tvMenuDisc = (TextView)v.findViewById(R.id.checkout_detail_item_disc);
        TextView tvMenuTotalPrice = (TextView)v.findViewById(R.id.checkout_detail_item_total_price);
        TextView tvTakeaway = (TextView)v.findViewById(R.id.checkout_detail_item_takeaway);
        TextView tvAdditional = (TextView)v.findViewById(R.id.checkout_detail_item_additional);
        ConstraintLayout menuStatusColor = (ConstraintLayout)v.findViewById(R.id.checkout_detail_item_status_color);
        LinearLayout discHolder = (LinearLayout)v.findViewById(R.id.checkout_detail_disc_holder);
        View item = v.findViewById(R.id.list_checkout_detail_item);
        ...
        return new ViewHolder(v, tvMenuName, tvMenuPrice, tvMenuQty, tvMenuDiscPrice, tvMenuDisc, tvMenuTotalPrice,
                    tvTakeaway, tvAdditional,  menuStatusColor, discHolder, item);
    }
