...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.ViewHolder>{
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, SwipeLayout swipeLayout,
                          TextView disc, TextView name, TextView price, TextView tvDisc, RMSwitch available,
    ...
    public MenuAdapter(ArrayList<Menu> menuList, MenuAdapterListener listener, MenuSettingActivity activity) {
