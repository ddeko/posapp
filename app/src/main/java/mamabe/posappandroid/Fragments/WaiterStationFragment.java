...
public class WaiterStationFragment extends BaseFragment  implements KitchenStatusAdapter.KitchenStatusAdapterListener,OptionDialog.OptionDialogListener{
    ...
    public void initView(View view) {
        listStatusConfirm = (RecyclerView) view.findViewById(R.id.waiter_station_cooked_list);
        listStatusCooking = (RecyclerView) view.findViewById(R.id.waiter_station_delivering_list);
        ...
        call.enqueue(new Callback<OrderTableResponse>() {
            ...
            public void onResponse(Call<OrderTableResponse> call, Response<OrderTableResponse> response) {
                ...
                if (2 == response.code() / 100) {
                    ...
                    if(menu_status.equals(MENUSTATUS_COOKED_CODE)){
                        confirmItems.clear();
                    ...
                    else if(menu_status.equals(MENUSTATUS_DELIVERING_CODE)){
                        cookingItems.clear();
                        for (OrderDetail orderResponseItem : listemp) {
